            ...
            <form className="flex flex-col gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Ej. Juan Pérez" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="nombre@ejemplo.com" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="password" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Mínimo 8 car." />
                  </div>
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="password" className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Repite..." />
                  </div>
                </div>
              </div>

              <div className="flex items-center gap-2 mt-2">
                <input type="checkbox" id="terms" className="w-5 h-5 text-primary border-gray-300 rounded focus:ring-primary" />
              ...
              <button type="button" className="mt-4 w-full bg-primary hover:bg-primary-dark text-text-main py-3 rounded-lg font-bold text-lg transition-colors shadow-sm">
                Crear Cuenta
              </button>
            </form>
